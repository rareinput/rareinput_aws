        ...
        <nav style="flex: 1; padding: 0.5rem 0.375rem; overflow-y: auto; overflow-x: hidden;">
            ...
            <a href="{{ route('admin.newsletters.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.newsletters.*') ? 'active' : '' }}">
                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="flex-shrink:0;"><path stroke-linecap="round" stroke-linejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                <span class="sidebar-label">Newsletters</span>
            </a>
