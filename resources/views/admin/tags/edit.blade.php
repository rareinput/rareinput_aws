<x-layouts.admin title="Edit Tag">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold mt-2" style="color: var(--color-heading);">Edit Tag</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.tags.update', $tag) }}" class="space-y-6" style="max-width: 560px;">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <textarea name="description" rows="3" class="form-input" style="resize: vertical;">{{ old('description', $tag->description) }}</textarea>
        </div>
