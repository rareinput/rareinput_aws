...
<head>
    ...
    <meta property="og:title" content="{{ $landingPage->meta_title ?: $content['hero']['headline_line1'] . ' — Rare Input' }}">
    ...
    <meta name="twitter:title" content="{{ $landingPage->meta_title ?: $content['hero']['headline_line1'] . ' — Rare Input' }}">
